...
# This file was *autogenerated* from the file ./scripts/test.sage
from sage.all_cmdline import *   # import sage library

_sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_3 = Integer(3); _sage_const_4 = Integer(4); _sage_const_0p5 = RealNumber('0.5'); _sage_const_20 = Integer(20); _sage_const_16 = Integer(16); _sage_const_100 = Integer(100); _sage_const_0 = Integer(0)
import numpy as np
...
C_precise = matrix(R100, M, K, _sage_const_0 )
A_m = matrix(R100, A)
B_m = matrix(R100, B)
C_precise = A_m * B_m
C = np.matmul(A, B)
...
R_print = RealField(_sage_const_20 )
